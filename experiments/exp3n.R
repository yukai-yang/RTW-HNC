...
# returned to work at some point in between 3 and 12 months after the medical treatment
...
tab = flextable(tab)  %>%
  ...
  set_caption(caption = "The results for IRTW-P2")
